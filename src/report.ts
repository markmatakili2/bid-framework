...
export function buildReport(): void {
  ...
  html += '<div style="text-align:center;margin-top:24px;padding-top:24px;border-top:1px solid #E5E7EB;">';
  html += '<button class="btn-ghost-land" onclick="openFeedbackModal()" style="font-size:13px;padding:8px 16px;">💬 Feedback</button>';
  html += '</div>';
  html += '</div></div>';
